...
[![WhatsApp](https://img.shields.io/badge/WhatsApp-%2B55%2015%2098129--3708-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://wa.me/5515981293708)
...
### 🏆 AMS HoldCrypto
![Status](https://img.shields.io/badge/Status-Concluído-success?style=flat-square) ![Stack](https://img.shields.io/badge/Stack-.NET%209%20|%20React%20Native%20|%20Python-blue?style=flat-square)

Plataforma profissional de gerenciamento de criptomoedas com arquitetura de microsserviços. 🏗️ API Gateway (Ocelot) | 🔄 Worker Service em tempo real (Binance API) | 📱 App mobile React Native + Zustand | 🤖 Chatbot integrado com LLM (Python/Flask) | 🔐 Autenticação JWT + Clean Architecture

### ✅ ASAC - App de Acessibilidade
![Status](https://img.shields.io/badge/Status-Em%20Produção-brightgreen?style=flat-square) ![Stack](https://img.shields.io/badge/Stack-React%20Native%20|%20AWS%20Serverless-blue?style=flat-square)

Sistema educacional em produção com conformidade WCAG 2.1. 🎓 Plataforma de ensino de Braille | 🌐 Infraestrutura Serverless (Lambda, DynamoDB, S3, Cognito) | 📱 Sincronização offline em tempo real | ♿ Acessibilidade WCAG 2.1 AA | 🏢 Utilizado por ONG em Sorocaba - TCC FATEC

### 🏍️ Fórum de Motocicletas
![Status](https://img.shields.io/badge/Status-Concluído-success?style=flat-square) ![Stack](https://img.shields.io/badge/Stack-Laravel%20|%20PHP%20|%20MySQL-blue?style=flat-square)
